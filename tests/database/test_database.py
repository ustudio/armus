...
class TestCassandraMigrationDatabase(unittest.TestCase):
    ...
    def test_setup_creates_table(self):
        ...
        expected_calls =[
            call("CREATE KEYSPACE IF NOT EXISTS test_keyspace WITH REPLICATION = { 'class': 'SimpleStrategy', 'replication_factor': 1};"),
    ...
    #
    #     expected_calls = [
    #         call("INSERT INTO migrations (versions) VALUES ('?')")
    #     ]
    #
